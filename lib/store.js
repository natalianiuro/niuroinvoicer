...
const initOnboarding = [
  {
    id: "ob1", personName: "Mónica Mondaca", role: "QA Engineer", startDate: "2025-10-14",
    checklist: { niuroCredentials: true, clientCredentials: true, computer: true, onboardingMeeting: true, ndaSigned: true },
    notes: "Onboarding completo.",
  },
  {
    id: "ob2", personName: "James Maradiaga", role: "Technical Lead", startDate: "2025-10-27",
    checklist: { niuroCredentials: true, clientCredentials: false, computer: true, onboardingMeeting: true, ndaSigned: true },
    notes: "Pendiente acceso cliente.",
  },
  {
    id: "ob3", personName: "Ana Torres", role: "Full Stack Engineer", startDate: "2026-01-15",
    checklist: { niuroCredentials: true, clientCredentials: true, computer: false, onboardingMeeting: true, ndaSigned: true },
    notes: "Sin computador asignado (usa propio).",
  },
  {
    id: "ob4", personName: "Lucas Ferreira", role: "Full Stack Engineer", startDate: "2026-01-20",
    checklist: { niuroCredentials: true, clientCredentials: true, computer: true, onboardingMeeting: true, ndaSigned: true },
    notes: "",
  },
  {
    id: "ob5", personName: "Isabella Mendoza", role: "Full Stack Engineer", startDate: "2026-04-01",
    checklist: { niuroCredentials: false, clientCredentials: false, computer: false, onboardingMeeting: false, ndaSigned: false },
...
const STORAGE_KEY = "niuro_hr_state_v2";
